...
const HeroSection = () => {
  return (
    ...
    <section className="bg-[url('https://media.licdn.com/dms/image/D5612AQEWtCdEtqfmsg/article-cover_image-shrink_600_2000/0/1696699790434?e=2147483647&v=beta&t=4eHd7ptWfNEBmmPO5iTRxPBaX0W6UJi_XKEUKH0EMcY')] bg-cover bg-center bg-no-repeat">
        ...
        <div className='bg-gradient-to-r from-fuchsia-400 to-transparent  pt-40 flex flex-row justify-around max-md:flex-col pb-24 '>
          <div className='flex flex-col justify-center w-2/5 max-md:w-[90%] max-md:m-auto'>
            <p className='text-white font-extralight text-[40px] max-lg:text-[28px] max-xl:text-[30px] '>
            ...
            <div className='flex justify-center pt-10'>
              ...
              <img src="https://images.msha.ke/d30b510f-8084-4048-8b89-5c3a7951a6e5?auto=format%2Ccompress&cs=tinysrgb&q=30&w=828" alt="TheRabbi" className='h-[80vh] flex flex-row justify-center rounded-2xl max-lg:h-[70vh]'/>
            </div>
        </div>
      </section>
    </>
